...
int main(void)
{
    ...
    int i;
    int included_houses;
    int included_streets = 0;
    int choice;
    double time = 0;
    double time_saved = 0;
    double total_distance_improved;
    ...
    time_saved = cal_time_saved(amount_street, p_array_house, p_array_street);

    time = cal_time(amount_street, p_array_house, p_array_street);


    result(total_distance_improved, total_distance, time_saved, time, included_houses, amount_house_total, amount_street, included_streets); 
